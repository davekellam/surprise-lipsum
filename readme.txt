...
Tags: lipsum, development, lorem-ipsum, lorem, ipsum, dev
...
3. Use `<?php sl_lipsum(); ?>` in your templates or [slipsum] in your content. Functions located in the plugin's functions.php file.
...
* Adding basic [slipsum] shortcode
